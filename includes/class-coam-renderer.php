	...
	?>
		<article class="coam-card" data-coam-card data-coam-search="<?php echo esc_attr($search); ?>">
			<div class="coam-card-top">
				<span class="coam-verified"><span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
							<path d="M0 0h24v24H0z" fill="none" />
							<path fill="#04703d" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12m13.523-3.308a.75.75 0 0 0-1.048.169l-3.597 4.981a.25.25 0 0 1-.391.018l-1.506-1.72a.75.75 0 1 0-1.129.987l1.506 1.721a1.75 1.75 0 0 0 2.736-.128l3.597-4.98a.75.75 0 0 0-.168-1.048" />
						</svg>
					</span> <?php esc_html_e('VERIFIED COA', 'coa-manager'); ?></span>
			...
			<div class="coam-actions">
				...
				<a class="coam-button coam-button-secondary" href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener noreferrer" <?php echo absint(COAM_Helpers::get_meta($post_id, 'file_id')) ? 'download' : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
																																				?>><?php esc_html_e('Download PDF', 'coa-manager'); ?></a>
			</div>
		</article>
	<?php
		return (string) ob_get_clean();
